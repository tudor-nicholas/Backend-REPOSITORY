...
<main class="container form-signin w-100 custom-main-box">
    <form class="custom-signin-box" action="DBconnect/loginDB.php" method="post">
        ...
        <div><?php
            ...
            if (isset($_GET["error"])) {
                ...
                } elseif ($_GET["error"] == 'userincorrect') {
                    echo '<p class="fs-4 text-danger border border-danger p-1">Username/Email incorect</p>';
                } elseif ($_GET["error"] == 'passwordincorrect') {
                    echo '<p class="fs-4 text-danger border border-danger p-1">Parola incorecta</p>';
                }
            }
